...
public final class ChoreoVars {
    ...
    public static final class Poses {
        ...
        public static final Pose2d NeutralFarmStart = new Pose2d(7.7014436, 6.4420453, Rotation2d.fromRadians(-1.5707963));
        public static final Pose2d NeutralFarmStop = new Pose2d(7.7014436, 5.1, Rotation2d.fromRadians(-1.5707963));
